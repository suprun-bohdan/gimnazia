    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="row">
                    <div class="col-lg-6">
                        <form method="post" action="{{ route('editFieldPost') }}">
                            {{ csrf_field() }}
                            <input type="hidden" value="{{ $setting->id }}" name="id">
                            <div class="form-group">
                                <label for="value">Значення (англ)</label>
                                <input class="form-control" value="{{ $setting->value }}" name="value"  maxlength="254" id="value" type="text">
                            </div>
                            <div class="form-group">
                                <label for="value">Дані (англ)</label>
                                <input class="form-control" name="data" value="{{ $setting->data }}" maxlength="254" id="data" type="text">
                            </div>
